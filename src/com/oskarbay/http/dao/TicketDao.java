package com.oskarbay.http.dao;

import com.oskarbay.http.entity.Ticket;
import com.oskarbay.http.util.ConnectionManager;
...
public class TicketDao implements Dao<Long, Ticket> {
    ...
    public List<Ticket> findAllByFlightId(Long flightId) {
        try (var connection = ConnectionManager.get();
            ...
            prepareStatement.setObject(1,flightId); // установили вопрос(?) на preparestatement
